...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    let dressPicture = ["/assets/images/SequinStripeSleevelessWrapDress.jpg", "/assets/images/ZoeBrushstrokeSequinV-NeckMiniDress.png", "/assets/images/OmbreSequinedShort-SleeveMiniDress.png", "/assets/images/ButterflySleeveStretchSilkDressBlack", "/assets/images/RosiemarieOff-the-shoulderStraightDresswRuffled", "/assets/images/StripedSequinShort-SleeveMiniCocktailDress", "/assets/images/One-ShoulderLongSatinDress", "/assets/images/Off-the-ShoulderFloral-PrintedStripedOrganzaGownwith3DFlowers", "/assets/images/KieraStraplessSide-SlitFrillGown", "/assets/images/EmbellishedSatinIllusionTrumpetGown", "/assets/images/KaitlynAsymmetricalCutoutGown", "/assets/images/Off-theShoulderOmbreTexturedGown"];
